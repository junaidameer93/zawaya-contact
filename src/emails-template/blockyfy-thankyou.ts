export const blockyfyThankyouTemplate = ({ interests }: { interests: string[] }) => {
  const ASSET_BASE_URL =
    'https://firebasestorage.googleapis.com/v0/b/soll-wallet.firebasestorage.app/o';

  const assets = {
    logo: `${ASSET_BASE_URL}/Frame%201.png?alt=media&token=11a6ec92-5fe1-4bb8-ad06-ac65c979e9a8`,
...
<head>
  ...
  <title>Thank You for Contacting Blockyfy Solutions</title>
  <style type="text/css">
...
<body
  ...
  <div style="display: none; max-height: 0; overflow: hidden;">
    Thank you for contacting Blockyfy Solutions. We've received your inquiry and will get back to you shortly.
  </div>
              ...
              <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                      ...
                      <tr>
                        <td style="padding-right: 12px; vertical-align: middle;">
                          ...
                          <table role="presentation" cellspacing="0" cellpadding="0" border="0" class="header-logo-table"
                            ...
                            <tr>
                              <td class="header-logo-table" style="width: 250px; text-align: center; vertical-align: middle;">
                                <img style="width: 250px; max-width: 100%; height: auto;" class="header-logo-img" src=${assets.logo} alt='img-header-logo'/>
                      ...
                      <tr>
                        <td
                          ...
                          <p style="margin: 0;">Thank you for contacting
                            <strong style="font-weight: 700;">Blockyfy Solutions.</strong>
                          </p>
                        </td>
                      </tr>
                    </table>
                ...
                <tr>
                  <td style="padding-bottom: 20px;">
                    <p
                      ...
                      Best regards,<br/>
                      <span style="font-weight: 600;">Blockyfy Team</span>
                    </p>
                  </td>
                </tr>
                ...
                <tr>
                  <td style="padding-bottom: 30px;">
                    <table role="presentation" cellspacing="0" cellpadding="0" border="0">
                      <tr>
                        <td style="background-color: #0069FF; border-radius: 7px; mso-padding-alt: 10px 13px;">
                          <a href="https://blockyfy.com/" target="_blank"
                              ...
                              <td>
                                <table role="presentation" cellspacing="0" cellpadding="0" border="0">
                                  <tr>
                                    ...
                                    <!-- LinkedIn -->
                                    <td>
                                      <a href="https://www.linkedin.com/company/blockyfy-software-solutions" target="_blank"
                      ...
                      <tr>
                        <td class="help-box" style="padding: 19px 23px;">
                          ...
                          <p
                            ...
                            We are here to help, learn more about Blockyfy solutions here or <a
                              href="tel:+447441348210" target="_blank"
                                ...
                                <table role="presentation" cellspacing="0" cellpadding="0" border="0"
                                  ...
                                  <tr>
                                    <td style="width: 180px; text-align: center; vertical-align: middle;">
                                      <img style="width: 180px; max-width: 100%; height: auto;" src=${assets.logo} alt='img-logo-footer'>
                                    </td>
                                  </tr>
                                </table>
                              </td>
                      ...
                      <tr>
                        <td align="center">
                          ...
                          <p
                            ...
                            © ${new Date().getFullYear()} Blockyfy Solutions
                          </p>
                        </td>
                      </tr>
                    </table>
